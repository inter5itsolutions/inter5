    ...
    >
      <div className="container-wide flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-5">
          ...
          <Link
            href="/contact"
            className="relative group overflow-hidden bg-gradient-to-r from-brand-orange to-teal-blue hover:shadow-lg text-white text-sm font-medium px-6 py-2.5 rounded-full transition-all duration-300"
          >
        ...
        <button
          ...
          className="md:hidden relative w-10 h-10 rounded-lg hover:bg-gray-100 transition-colors focus:outline-none"
        >
        ...
        {open && (
          <>
            ...
            <motion.div
              ...
              className="md:hidden fixed top-[73px] left-0 right-0 bottom-0 bg-white shadow-2xl z-40 overflow-y-auto"
            >
