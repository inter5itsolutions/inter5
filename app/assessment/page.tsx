      ...
      <section className="bg-white border-b border-gray-200 pt-32 pb-16">
        <div className="container-wide">
          <div className="max-w-3xl mx-auto text-center">
            <span className="text-brand-orange text-sm font-semibold uppercase tracking-wider mb-4 block">
              Free Assessment
            </span>
            <h1 className="text-4xl md:text-5xl font-display font-bold text-dark-blue mb-6">
              Let us evaluate your 
              <span className="text-brand-orange"> IT infrastructure</span>
            </h1>
        ...
        <div className="container-wide">
          <div className="max-w-4xl mx-auto">
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
              <div className="bg-brand-orange/5 border-b border-brand-orange/20 px-8 py-6">
                <h2 className="text-2xl font-display font-semibold text-dark-blue">
            ...
            <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600">Response within <strong className="text-dark-blue">24 hours</strong></p>
              </div>
              <div className="text-center">
                <div className="w-12 h-12 bg-brand-orange/10 rounded-full flex items-center justify-center mx-auto mb-3">
                  <svg className="w-6 h-6 text-brand-orange" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <p className="text-sm text-gray-600"><strong className="text-dark-blue">100% confidential</strong> — your data is safe</p>
              </div>
              <div className="text-center">
                <div className="w-12 h-12 bg-brand-orange/10 rounded-full flex items-center justify-center mx-auto mb-3">
                  <svg className="w-6 h-6 text-brand-orange" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <p className="text-sm text-gray-600"><strong className="text-dark-blue">No obligation</strong> — just honest advice</p>
              </div>
            </div>
          </div>
        </div>
