          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              >
                <Link
                  href="/assessment"
                  className="inline-flex items-center gap-3 bg-blue-500 hover:bg-blue-600 text-white px-8 py-4 rounded-lg font-semibold text-lg transition-all duration-300 shadow-xl"
                >
        ...
        <div className="container-wide">
          ...
          >
            <motion.div variants={fadeInUp} className="text-center mb-12">
              ...
              <p className="text-xl text-charcoal-600">Are Destroying SMEs Across Nigeria</p>
            </motion.div>
        ...
        <div className="container-wide text-center">
          ...
          >
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Link
                href="/assessment"
                className="inline-flex items-center gap-3 bg-blue-500 hover:bg-blue-600 text-white px-8 py-4 rounded-lg font-semibold text-lg transition-all duration-300"
              >
                <Calendar className="w-5 h-5" />
